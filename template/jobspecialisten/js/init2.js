var a = {
	init: function(){
		this.communicationdiagram();
	},
	random: function(l, u){
		return Math.floor((Math.random()*(u-l+1))+l);
	},
	communicationdiagram: function(){
		var r = Raphael('communicationdiagram', 470, 470),
			rad = 63,
			defaultText = 'Kommunikation',
			speed = 250;
		...
		$('.getcom').find('.arc2').each(function(i){
			var t = $(this), 
